import {
    ...
    SelectionMode, ShimmeredDetailsList, FontIcon, IRenderFunction, IDetailsHeaderProps, IDetailsColumnRenderTooltipProps, TooltipHost, Pivot, PivotItem, Label
...
export default class SDKs extends React.Component<{ isAuthenticated: boolean }, ISamplesState> {
